...
function Register() {
  ...
  {...register('phone', { required: { value: true, message: 'Enter a pnone No'},minLength: { value: 2, message: 'Length should be greater than 2'},maxLength: { value: 10, message: 'Length should be lesser than 10'} })}
                  />
